import type { KbModuleSource, KbRequest, KbUpdateSource } from "./types";
...
export const MODULES: KbModuleSource[] = [
  { title: "Start here", children: [
    { title: "Before you request checklist", updated: "February 4, 2026", summary: "Three checks must pass before the automation request opens: a Brainwave submission at Project status, an uploaded project charter and a named POC. Each yes needs evidence, so the gate cannot be clicked through.",
      cards: [{ title: "Brainwave submission at Project status", body: "Upload a screenshot showing the submission has reached Project status in Brainwave." }, { title: "Project charter", body: "Upload the signed charter using the library template." }, { title: "POC identified", body: "Name the process owner who will answer follow-ups." }],
    ...
    { title: "Brainwave submission guide", updated: "February 4, 2026", summary: "Every idea must be submitted in Brainwave and reach Project status before an automation request can be submitted. A submission moves through five phases: Submitted, IC Review, Champion Review, BITS Review and Project. Once it shows Project, take the screenshot the request form asks for.",
      cards: [{ title: "Submit in Brainwave", body: "Submit your idea at teamcgs.io/brainwave. It starts in the Submitted phase." }, { title: "Pass the reviews", body: "It then moves through IC Review, Champion Review and BITS Review." }, { title: "Reach Project status", body: "Only a submission at Project status can be used to request an automation." }],
      resources: [{ title: "Submit in Brainwave", kind: "Link · teamcgs.io", link: "https://teamcgs.io/brainwave" }, { title: "Before you request checklist", kind: "Guide · 2 min", link: "start-here/before-you-request-checklist" }] },
    { title: "Request process and timelines", updated: "January 28, 2026", summary: "How a request moves from draft to approved, who reviews it at each step, and how long each stage usually takes.",
      ...
      resources: [{ title: "Status definitions", kind: "Reference", link: "faqs-and-glossary/glossary" }, { title: "Typical review times", kind: "Reference" }] },
  ] },
  { title: "Platform guides", children: [
    { title: "Power Apps", updated: "February 4, 2026", summary: "Power Apps suits internal tools with a known user group, data held in SharePoint or Dataverse, and approved connectors. It is the fastest route for forms, trackers and approval flows.",
      ...
      resources: [{ title: "Choosing between Power Apps and a web app", kind: "Guide · 6 min", link: "platform-guides/selection-criteria" }, { title: "Licensing and approved connectors", kind: "Reference", link: "environments-and-licensing/approved-connectors" }, { title: "Power Apps screen template", kind: "Template · .msapp" }] },
    { title: "Web app", updated: "January 28, 2026", summary: "Web apps suit tools with many users, complex logic or integrations outside the Power Platform. Built and hosted by BITS on the approved stack.",
      ...
      resources: [{ title: "Web app development flow, v2", kind: "Guide · 8 min", link: "development-flows/web-app-flow" }, { title: "Hosting and deployment", kind: "Reference", link: "environments-and-licensing/environments" }] },
    { title: "Desktop app", updated: "December 12, 2025", summary: "Desktop apps suit tasks tied to local files or legacy systems that cannot be reached from the browser.",
    ...
    { title: "Selection criteria", updated: "February 4, 2026", summary: "How BITS chooses a platform: number of users, data sources, integration needs, complexity and support model.",
...
export const UPDATES: KbUpdateSource[] = [
  { when: "2 days ago", what: "Approved connectors list revised", link: "environments-and-licensing/approved-connectors" },
  { when: "Last week", what: "New UAT checklist template added", link: "templates-library/uat-checklist" },
  { when: "January 28, 2026", what: "Web app development flow, v2", link: "development-flows/web-app-flow" },
];
