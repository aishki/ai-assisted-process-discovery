...
export const MODULES: KbModuleSource[] = [
  { title: "Start here", children: [
    { title: "Before you request checklist", updated: "February 4, 2026", summary: "Four checks must pass before the automation request opens: an identified opportunity, an uploaded project charter, a named POC and an uploaded project storyboard. Each yes needs evidence, so the gate cannot be clicked through.",
